                        ...
                        if ($hiperCorreo === 'armandoutfv@gmail.com'){
                          ...
                          <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <li><a class="dropdown-item" href="consul.php">Consultar Productos</a></li>
                              <li><a class="dropdown-item" href="productos.php">Agreagar un Producto</a></li>
        ...
        <div class="col-md-5 mx-auto" style="margin-top: 10px;">
          <?php
               ...
               while($res = $cs -> fetchArray()) {
                    ...
                    $piezas= $res['piezas'];
                    echo' 
                    <div class="card" style="margin-top: 35px; background-color: #954595;">
